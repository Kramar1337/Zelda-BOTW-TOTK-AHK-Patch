...
WinGetPos, 228X, 228Y, 228Width1337, 228Height1337, Cemu 1.
if 228Width1337 = %A_ScreenWidth%
if 228Height1337 = %A_ScreenHeight%
{
WinActivate %gameexe1337%
sleep 100
SendInput !{Enter}
...
WinActivate %gameexe1337%
sleep 200
ControlSend,, {F10},%gameexe1337%
sleep 200
ControlSend,, {N},%gameexe1337%
sleep 200
ControlSend,, {S},%gameexe1337%
sleep 1000
...
ControlSend,, {F10},%gameexe1337%
sleep 200
ControlSend,, {O},%gameexe1337%
sleep 200
ControlSend,, {F},%gameexe1337%
sleep 200
WinActivate %gameexe1337%
}
sleep 200
...
if (toggle1)
{
	...
	{
		Gosub, controllerSwitch
		run_param="https://www.zeldadungeon.net/breath-of-the-wild-interactive-map/"
...
if !toggle
{
	vstick.SetBtn(1,5) ;действие камн шика
	sleep 30
